...
run_required "installed_advanced_read_only_no_root_test" bash "$ROOT_DIR/tests/installed_advanced_read_only_no_root_test.sh"
...
run_required "wrapper_sidecar_write_fail_test" bash "$ROOT_DIR/tests/wrapper_sidecar_write_fail_test.sh"
run_required "wrapper_status_write_fail_test" bash "$ROOT_DIR/tests/wrapper_status_write_fail_test.sh"
run_required "wrapper_run_state_write_fail_test" bash "$ROOT_DIR/tests/wrapper_run_state_write_fail_test.sh"
...
run_required "run_lock_invalid_meta_test" bash "$ROOT_DIR/tests/run_lock_invalid_meta_test.sh"
run_required "run_resume_state_test" bash "$ROOT_DIR/tests/run_resume_state_test.sh"
run_required "run_resume_missing_state_test" bash "$ROOT_DIR/tests/run_resume_missing_state_test.sh"
run_required "run_resume_invalid_state_test" bash "$ROOT_DIR/tests/run_resume_invalid_state_test.sh"
...
run_required "wrapper_resume_invalid_state_test" bash "$ROOT_DIR/tests/wrapper_resume_invalid_state_test.sh"
...
run_required "metrics_unreadable_summary_test" bash "$ROOT_DIR/tests/metrics_unreadable_summary_test.sh"
...
run_required "plugin_invalid_name_test" bash "$ROOT_DIR/tests/plugin_invalid_name_test.sh"
...
run_required "policy_lint_duplicates_case_test" bash "$ROOT_DIR/tests/policy_lint_duplicates_case_test.sh"
...
run_required "status_since_history_warnings_test" bash "$ROOT_DIR/tests/status_since_history_warnings_test.sh"
run_required "status_last_history_warnings_test" bash "$ROOT_DIR/tests/status_last_history_warnings_test.sh"
run_required "status_unreadable_last_status_test" bash "$ROOT_DIR/tests/status_unreadable_last_status_test.sh"
run_required "status_malformed_last_status_test" bash "$ROOT_DIR/tests/status_malformed_last_status_test.sh"
run_required "status_unreadable_summary_test" bash "$ROOT_DIR/tests/status_unreadable_summary_test.sh"
run_required "report_bad_last_status_test" bash "$ROOT_DIR/tests/report_bad_last_status_test.sh"
run_required "report_history_warnings_test" bash "$ROOT_DIR/tests/report_history_warnings_test.sh"
...
run_required "export_unreadable_wrapper_log_test" bash "$ROOT_DIR/tests/export_unreadable_wrapper_log_test.sh"
