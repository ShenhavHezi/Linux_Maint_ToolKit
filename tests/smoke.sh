...
run_required "support_lib_payload_parity_test" bash "$ROOT_DIR/tests/support_lib_payload_parity_test.sh"
...
run_required "install_systemd_best_effort_test" bash "$ROOT_DIR/tests/install_systemd_best_effort_test.sh"
...
run_required "upgrade_command_override_layout_test" bash "$ROOT_DIR/tests/upgrade_command_override_layout_test.sh"
