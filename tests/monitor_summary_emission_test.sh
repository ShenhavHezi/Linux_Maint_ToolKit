...
export LM_LOG_DIR="${TMPDIR}"
export LM_LOGFILE=${TMPDIR}/linux_maint_test.log
export LM_STATE_DIR=${TMPDIR}/linux_maint_state
...
export LM_CFG_DIR="${LM_CFG_DIR:-${TMPDIR}/linux_maint_cfg}"
